...
#define HAVE_gen_op_sdiv_32_T0_T1
{
    static const uint8 op_sdiv_32_T0_T1_code[] = {
       0x89, 0xd8, 0x99, 0xf7, 0xfe, 0x89, 0xc3
    };
    copy_block(op_sdiv_32_T0_T1_code, 7);
    inc_code_ptr(7);
}
#endif
...
#define HAVE_gen_op_lsl_32_T0_im
{
    static const uint8 op_lsl_32_T0_im_code[] = {
       0xb8, 0x00, 0x00, 0x00, 0x00, 0x88, 0xc1, 0xd3, 0xe3
    };
    copy_block(op_lsl_32_T0_im_code, 9);
    *(uint32_t *)(code_ptr() + 1) = param1 + 0;
    inc_code_ptr(9);
}
#endif
...
#define HAVE_gen_op_lsr_32_T0_im
{
    static const uint8 op_lsr_32_T0_im_code[] = {
       0xb8, 0x00, 0x00, 0x00, 0x00, 0x88, 0xc1, 0xd3, 0xeb
    };
    copy_block(op_lsr_32_T0_im_code, 9);
    *(uint32_t *)(code_ptr() + 1) = param1 + 0;
    inc_code_ptr(9);
}
#endif
...
#define HAVE_gen_op_asr_32_T0_im
{
    static const uint8 op_asr_32_T0_im_code[] = {
       0xb8, 0x00, 0x00, 0x00, 0x00, 0x88, 0xc1, 0xd3, 0xfb
    };
    copy_block(op_asr_32_T0_im_code, 9);
    *(uint32_t *)(code_ptr() + 1) = param1 + 0;
    inc_code_ptr(9);
}
#endif
...
#define HAVE_gen_op_rol_32_T0_im
{
    static const uint8 op_rol_32_T0_im_code[] = {
       0xb8, 0x00, 0x00, 0x00, 0x00, 0x88, 0xc1, 0xd3, 0xc3
    };
    copy_block(op_rol_32_T0_im_code, 9);
    *(uint32_t *)(code_ptr() + 1) = param1 + 0;
    inc_code_ptr(9);
}
#endif
...
#define HAVE_gen_op_ror_32_T0_im
{
    static const uint8 op_ror_32_T0_im_code[] = {
       0xb8, 0x00, 0x00, 0x00, 0x00, 0x88, 0xc1, 0xd3, 0xcb
    };
    copy_block(op_ror_32_T0_im_code, 9);
    *(uint32_t *)(code_ptr() + 1) = param1 + 0;
    inc_code_ptr(9);
}
#endif
...
#define HAVE_gen_op_load_u32_T0_T1_0
{
    static const uint8 op_load_u32_T0_T1_0_code[] = {
       0x8b, 0x86, 0x00, 0x00, 0x00, 0x11, 0x89, 0xc3, 0x0f, 0xcb
    };
    copy_block(op_load_u32_T0_T1_0_code, 10);
    inc_code_ptr(10);
}
#endif
...
#define HAVE_gen_op_load_s32_T0_T1_0
{
    ...
    copy_block(op_load_s32_T0_T1_0_code, 10);
    inc_code_ptr(10);
}
#endif
...
#define HAVE_gen_op_store_32_T0_T1_0
{
    static const uint8 op_store_32_T0_T1_0_code[] = {
       0x89, 0xd8, 0x0f, 0xc8, 0x89, 0x86, 0x00, 0x00, 0x00, 0x11
    };
...
#define HAVE_gen_op_load_u32_T0_T1_im
{
    ...
    *(uint32_t *)(code_ptr() + 2) = param1 + 285212672;
    inc_code_ptr(10);
}
#endif
...
#define HAVE_gen_op_store_32_T0_T1_im
{
    static const uint8 op_store_32_T0_T1_im_code[] = {
       0x8d, 0x96, 0x00, 0x00, 0x00, 0x00, 0x89, 0xd8, 0x0f, 0xc8, 0x89, 0x82,
       0x00, 0x00, 0x00, 0x11
    };
    copy_block(op_store_32_T0_T1_im_code, 16);
    *(uint32_t *)(code_ptr() + 2) = param1 + 0;
    inc_code_ptr(16);
}
#endif
...
#define HAVE_gen_op_load_u32_T0_T1_T2
{
    static const uint8 op_load_u32_T0_T1_T2_code[] = {
       0x8b, 0x84, 0x3e, 0x00, 0x00, 0x00, 0x11, 0x89, 0xc3, 0x0f, 0xcb
    };
    copy_block(op_load_u32_T0_T1_T2_code, 11);
    inc_code_ptr(11);
}
#endif
...
#define HAVE_gen_op_load_s32_T0_T1_T2
{
    ...
    copy_block(op_load_s32_T0_T1_T2_code, 11);
    inc_code_ptr(11);
}
#endif
...
#define HAVE_gen_op_store_32_T0_T1_T2
{
    static const uint8 op_store_32_T0_T1_T2_code[] = {
       0x8d, 0x14, 0x3e, 0x89, 0xd8, 0x0f, 0xc8, 0x89, 0x82, 0x00, 0x00, 0x00,
       0x11
    };
...
#define HAVE_gen_op_load_u8_T0_T1_0
{
    static const uint8 op_load_u8_T0_T1_0_code[] = {
       0x0f, 0xb6, 0x9e, 0x00, 0x00, 0x00, 0x11
    };
...
#define HAVE_gen_op_load_s8_T0_T1_0
{
    static const uint8 op_load_s8_T0_T1_0_code[] = {
       0x0f, 0xbe, 0x9e, 0x00, 0x00, 0x00, 0x11
    };
...
#define HAVE_gen_op_load_u8_T0_T1_T2
{
    static const uint8 op_load_u8_T0_T1_T2_code[] = {
       0x0f, 0xb6, 0x9c, 0x3e, 0x00, 0x00, 0x00, 0x11
    };
...
#define HAVE_gen_op_load_s8_T0_T1_T2
{
    static const uint8 op_load_s8_T0_T1_T2_code[] = {
       0x0f, 0xbe, 0x9c, 0x3e, 0x00, 0x00, 0x00, 0x11
    };
...
#define HAVE_gen_op_store_8_T0_T1_T2
{
    static const uint8 op_store_8_T0_T1_T2_code[] = {
       0x88, 0x9c, 0x3e, 0x00, 0x00, 0x00, 0x11
    };
...
#define HAVE_gen_op_execute
{
    static const uint8 op_execute_code[] = {
       0x83, 0xec, 0x50, 0x89, 0x6c, 0x24, 0x4c, 0x8b, 0x6c, 0x24, 0x58, 0x89,
       0x5c, 0x24, 0x48, 0x89, 0x74, 0x24, 0x44, 0x89, 0x7c, 0x24, 0x40, 0xff,
       0x64, 0x24, 0x54, 0x90, 0x8d, 0x74, 0x26, 0x00, 0xff, 0x54, 0x24, 0x54,
       0x8b, 0x7c, 0x24, 0x40, 0x8b, 0x74, 0x24, 0x44, 0x8b, 0x5c, 0x24, 0x48,
       0x8b, 0x6c, 0x24, 0x4c, 0x83, 0xc4, 0x50, 0xc3, 0x90, 0x8d, 0xb4, 0x26,
       0x00, 0x00, 0x00, 0x00
    };
    copy_block(op_execute_code, 64);
    inc_code_ptr(64);
}
#endif
...
#define HAVE_gen_op_jmp_fast
{
    ...
    *(uint32_t *)(code_ptr() + 1) = param1 - (long)(code_ptr() + 1) + 0 -4;
    inc_code_ptr(5);
}
#endif
...
#define HAVE_gen_op_invoke_T0
{
    static const uint8 helper_op_invoke_T0_code[] = {
       0x83, 0xec, 0x04, 0x89, 0x1c, 0x24, 0xe8, 0x00, 0x00, 0x00, 0x00, 0x58
    };
    copy_block(helper_op_invoke_T0_code, 12);
    *(uint32_t *)(code_ptr() + 7) = param1 - (long)(code_ptr() + 7) + 0 -4;
    inc_code_ptr(12);
}
#endif
...
#define HAVE_gen_op_invoke_T0_T1
{
    static const uint8 helper_op_invoke_T0_T1_code[] = {
       0x83, 0xec, 0x08, 0x89, 0x74, 0x24, 0x04, 0x89, 0x1c, 0x24, 0xe8, 0x00,
       0x00, 0x00, 0x00, 0x83, 0xc4, 0x08
    };
    copy_block(helper_op_invoke_T0_T1_code, 18);
    *(uint32_t *)(code_ptr() + 11) = param1 - (long)(code_ptr() + 11) + 0 -4;
    inc_code_ptr(18);
}
#endif
...
#define HAVE_gen_op_invoke_T0_T1_T2
{
    static const uint8 helper_op_invoke_T0_T1_T2_code[] = {
       0x83, 0xec, 0x0c, 0x89, 0x7c, 0x24, 0x08, 0x89, 0x74, 0x24, 0x04, 0x89,
       0x1c, 0x24, 0xe8, 0x00, 0x00, 0x00, 0x00, 0x83, 0xc4, 0x0c
    };
    copy_block(helper_op_invoke_T0_T1_T2_code, 22);
    *(uint32_t *)(code_ptr() + 15) = param1 - (long)(code_ptr() + 15) + 0 -4;
    inc_code_ptr(22);
}
#endif
...
#define HAVE_gen_op_invoke_T0_ret_T0
{
    static const uint8 helper_op_invoke_T0_ret_T0_code[] = {
       0x83, 0xec, 0x04, 0x89, 0x1c, 0x24, 0xe8, 0x00, 0x00, 0x00, 0x00, 0x5a,
       0x89, 0xc3
    };
    copy_block(helper_op_invoke_T0_ret_T0_code, 14);
    *(uint32_t *)(code_ptr() + 7) = param1 - (long)(code_ptr() + 7) + 0 -4;
    inc_code_ptr(14);
}
#endif
...
#define HAVE_gen_op_invoke_im
{
    static const uint8 helper_op_invoke_im_code[] = {
       0x83, 0xec, 0x04, 0xc7, 0x04, 0x24, 0x00, 0x00, 0x00, 0x00, 0xe8, 0x00,
       0x00, 0x00, 0x00, 0x59
    };
    copy_block(helper_op_invoke_im_code, 16);
    *(uint32_t *)(code_ptr() + 6) = param2 + 0;
    *(uint32_t *)(code_ptr() + 11) = param1 - (long)(code_ptr() + 11) + 0 -4;
    inc_code_ptr(16);
}
#endif
...
#define HAVE_gen_op_invoke_CPU
{
    static const uint8 helper_op_invoke_CPU_code[] = {
       0x83, 0xec, 0x04, 0x89, 0x2c, 0x24, 0xe8, 0x00, 0x00, 0x00, 0x00, 0x58
    };
    copy_block(helper_op_invoke_CPU_code, 12);
    *(uint32_t *)(code_ptr() + 7) = param1 - (long)(code_ptr() + 7) + 0 -4;
    inc_code_ptr(12);
}
#endif
...
#define HAVE_gen_op_invoke_CPU_T0
{
    static const uint8 helper_op_invoke_CPU_T0_code[] = {
       0x83, 0xec, 0x08, 0x89, 0x5c, 0x24, 0x04, 0x89, 0x2c, 0x24, 0xe8, 0x00,
       0x00, 0x00, 0x00, 0x83, 0xc4, 0x08
    };
...
#define HAVE_gen_op_invoke_CPU_im
{
    static const uint8 helper_op_invoke_CPU_im_code[] = {
       0x83, 0xec, 0x08, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x89, 0x44, 0x24, 0x04,
       0x89, 0x2c, 0x24, 0xe8, 0x00, 0x00, 0x00, 0x00, 0x83, 0xc4, 0x08
    };
    copy_block(helper_op_invoke_CPU_im_code, 23);
    *(uint32_t *)(code_ptr() + 4) = param2 + 0;
    *(uint32_t *)(code_ptr() + 16) = param1 - (long)(code_ptr() + 16) + 0 -4;
    inc_code_ptr(23);
}
#endif
...
#define HAVE_gen_op_invoke_CPU_im_im
{
    static const uint8 helper_op_invoke_CPU_im_im_code[] = {
       0x83, 0xec, 0x0c, 0xb8, 0x00, 0x00, 0x00, 0x00, 0x89, 0x44, 0x24, 0x08,
       0xb8, 0x00, 0x00, 0x00, 0x00, 0x89, 0x44, 0x24, 0x04, 0x89, 0x2c, 0x24,
       0xe8, 0x00, 0x00, 0x00, 0x00, 0x83, 0xc4, 0x0c
    };
    copy_block(helper_op_invoke_CPU_im_im_code, 32);
    *(uint32_t *)(code_ptr() + 4) = param3 + 0;
    *(uint32_t *)(code_ptr() + 13) = param2 + 0;
    *(uint32_t *)(code_ptr() + 25) = param1 - (long)(code_ptr() + 25) + 0 -4;
    inc_code_ptr(32);
}
#endif
...
#define HAVE_gen_op_invoke_CPU_A0_ret_A0
{
    static const uint8 helper_op_invoke_CPU_A0_ret_A0_code[] = {
       0x83, 0xec, 0x08, 0x89, 0x5c, 0x24, 0x04, 0x89, 0x2c, 0x24, 0xe8, 0x00,
       0x00, 0x00, 0x00, 0x89, 0xc3, 0x83, 0xc4, 0x08
    };
    copy_block(helper_op_invoke_CPU_A0_ret_A0_code, 20);
    *(uint32_t *)(code_ptr() + 11) = param1 - (long)(code_ptr() + 11) + 0 -4;
    inc_code_ptr(20);
}
#endif
...
#define HAVE_gen_op_invoke_direct_T0
{
    ...
    copy_block(helper_op_invoke_direct_T0_code, 12);
    *(uint32_t *)(code_ptr() + 7) = param1 - (long)(code_ptr() + 7) + 0 -4;
    inc_code_ptr(12);
}
#endif
...
#define HAVE_gen_op_invoke_direct_T0_T1
{
    ...
    copy_block(helper_op_invoke_direct_T0_T1_code, 18);
    *(uint32_t *)(code_ptr() + 11) = param1 - (long)(code_ptr() + 11) + 0 -4;
    inc_code_ptr(18);
}
#endif
...
#define HAVE_gen_op_invoke_direct_T0_T1_T2
{
    ...
    copy_block(helper_op_invoke_direct_T0_T1_T2_code, 22);
    *(uint32_t *)(code_ptr() + 15) = param1 - (long)(code_ptr() + 15) + 0 -4;
    inc_code_ptr(22);
}
#endif
...
#define HAVE_gen_op_invoke_direct_T0_ret_T0
{
    static const uint8 helper_op_invoke_direct_T0_ret_T0_code[] = {
       0x83, 0xec, 0x04, 0x89, 0x1c, 0x24, 0xe8, 0x00, 0x00, 0x00, 0x00, 0x89,
       0xc3, 0x58
    };
    copy_block(helper_op_invoke_direct_T0_ret_T0_code, 14);
    *(uint32_t *)(code_ptr() + 7) = param1 - (long)(code_ptr() + 7) + 0 -4;
    inc_code_ptr(14);
}
#endif
...
#define HAVE_gen_op_invoke_direct_im
{
    ...
    copy_block(helper_op_invoke_direct_im_code, 16);
    *(uint32_t *)(code_ptr() + 6) = param2 + 0;
    *(uint32_t *)(code_ptr() + 11) = param1 - (long)(code_ptr() + 11) + 0 -4;
    inc_code_ptr(16);
}
...
#define HAVE_gen_op_invoke_direct_CPU
{
    static const uint8 helper_op_invoke_direct_CPU_code[] = {
       0x83, 0xec, 0x04, 0x89, 0x2c, 0x24, 0xe8, 0x00, 0x00, 0x00, 0x00, 0x59
    };
    copy_block(helper_op_invoke_direct_CPU_code, 12);
    *(uint32_t *)(code_ptr() + 7) = param1 - (long)(code_ptr() + 7) + 0 -4;
    inc_code_ptr(12);
}
#endif
...
#define HAVE_gen_op_invoke_direct_CPU_T0
{
    ...
    copy_block(helper_op_invoke_direct_CPU_T0_code, 18);
    *(uint32_t *)(code_ptr() + 11) = param1 - (long)(code_ptr() + 11) + 0 -4;
    inc_code_ptr(18);
}
#endif
...
#define HAVE_gen_op_invoke_direct_CPU_im
{
    ...
    copy_block(helper_op_invoke_direct_CPU_im_code, 23);
    *(uint32_t *)(code_ptr() + 4) = param2 + 0;
    *(uint32_t *)(code_ptr() + 16) = param1 - (long)(code_ptr() + 16) + 0 -4;
    inc_code_ptr(23);
}
...
#define HAVE_gen_op_invoke_direct_CPU_im_im
{
    ...
    copy_block(helper_op_invoke_direct_CPU_im_im_code, 32);
    *(uint32_t *)(code_ptr() + 4) = param3 + 0;
    *(uint32_t *)(code_ptr() + 13) = param2 + 0;
    *(uint32_t *)(code_ptr() + 25) = param1 - (long)(code_ptr() + 25) + 0 -4;
    inc_code_ptr(32);
...
#define HAVE_gen_op_invoke_direct_CPU_A0_ret_A0
{
    ...
    copy_block(helper_op_invoke_direct_CPU_A0_ret_A0_code, 20);
    *(uint32_t *)(code_ptr() + 11) = param1 - (long)(code_ptr() + 11) + 0 -4;
    inc_code_ptr(20);
}
#endif

DEFINE_CST(op_exec_return_offset,0x24L)
